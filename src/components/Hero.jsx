...
const Hero = () => {
    ...
    return (
        <section className=' bg-hero-pattern w-full h-full bg-cover bg-no-repeat'>
            <div className="max-w-7xl flex-col gap-7 mx-auto h-[60vh]  flex justify-center items-center">

                <div className='flex flex-col text-center text-gray-300 gap-4 font-medium text-xl'>
