                ...
                <div className="p-4 md:p-5 ">
                    {
                        results ? (
                            ...
                            <div className='rounded-md shadow-sm flex items-center justify-center
                            border border-gray-300 bg-white py-2 px-6
                            text-base font-medium text-gray-900 hover:text-gray
                            -900 focus:ring ring-indigo-500 focus:border
                            border-transparent cursor-wait transition ease-
                            medium duration-150 sm:py-4 sm:text-base'>Loading
                                ...</div>
                        )
                    }
